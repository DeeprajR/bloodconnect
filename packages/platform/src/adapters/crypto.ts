...
import type { PasswordHasher, TokenGenerator } from '../context.js';
...
export const nodeTokens: TokenGenerator = {
  ...
  /**
   * Rejection sampling rather than `% 1000000`.
   *
   * Taking a modulus of a uniform 32-bit value skews the low codes slightly
   * more likely, and a bias in a six-digit secret is exactly the kind of thing
   * that is invisible in testing and quietly narrows the search.
   */
  issueOtp: (): string => {
