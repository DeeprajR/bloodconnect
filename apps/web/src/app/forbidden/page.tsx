 ...
 * account, not the role, not what would have been shown. §14 names the
 * mistake to avoid: a test that asserts the redirect rather than the
 * body, passing while a JSON payload rides along underneath. There is
 * nothing here to ride along, and the role-matrix test asserts exactly
 * that.
 *
 * It does not offer a sign-in link either. The visitor is already signed
 * in; suggesting another account might work is untrue and an invitation.
 */
